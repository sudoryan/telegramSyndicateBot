...
async function addMemberListToWhitelist(manager, memberList) {
  ...
  let instance = await contract.methods.addInvestors(memberList);
...
module.exports = addMemberListToWhitelist;
